...
///
/// This sink batches events, converts them to Parquet format, and writes them
/// to Delta Lake with proper transaction log management.
    ...
    S::Error: std::fmt::Debug + Into<crate::Error> + Send,
{
    ...
    /// * `request_builder` - Builder for converting events to Parquet requests
    ...
    async fn run_inner(self: Box<Self>, input: BoxStream<'_, Event>) -> Result<(), ()> {
        ...
        input
            ...
            // Build requests (convert to Parquet)
            .request_builder(
